...
const Reviews = () => {
	return (
		<div className={marginSequence}>
			<section className="relative py-20 md:py-32 bg-orange-300 overflow-x-hidden">
				<img
							...
							<div className="relative px-4 mx-auto">
								...
								<div className="px-4 md:px-10">
									<h3 className="mb-8 text-xl font-bold font-heading text-white">
										Thanks, feugiat tellus a sad tincidunt ultrices. Phasellus non libero
										tempus odio vestibulum ultricies.
									</h3>
									<div className="flex flex-wrap items-center">
										<img
											className="mb-4 md:mb-0 mr-6 rounded-full"
											src="https://i.ibb.co/V99w9rV/Screenshot-from-2024-02-25-01-25-07.png"
											alt=""
										/>
					...
					<div className="flex-shrink-0 w-full lg:max-w-md px-3 lg:mt-20 mb-6 lg:mb-0">
						<div className="px-8 py-16 bg-blue-300">
							<div className="relative px-4 mx-auto">
								...
								<div className="px-4 md:px-10">
									<h3 className="mb-8 text-xl font-bold font-heading text-white">
										Tonight I had interdum at ante porta, eleifend feugiat nunc. In semper
										euismod me a accumsan. Thanks! 👏💥
									</h3>
									<div className="flex flex-wrap items-center">
										<img
											className=" mb-4 md:mb-0 mr-6 rounded-full"
											src="https://i.ibb.co/HPRttn4/Screenshot-20230929-005816.jpg"
											alt=""
										/>
					...
					<div className="flex-shrink-0 w-full lg:max-w-md px-3 lg:mt-20 mb-6 lg:mb-0">
						<div className="px-8 py-16 bg-blue-300">
							<div className="relative px-4 mx-auto">
								...
								<div className="px-4 md:px-10">
									<h3 className="mb-8 text-xl font-bold font-heading text-white">
										This time ut augue ut magna rutrum ultricies nec nec leo. Proin
										tempor, mauris sad senne lorem.
									</h3>
									<div className="flex flex-wrap items-center">
										<img
											className="mb-4 md:mb-0 mr-6 rounded-full"
											src="https://i.ibb.co/wd3bfQf/386471815-219646347788449-718444647781112055-n.jpg"
											alt=""
										/>
