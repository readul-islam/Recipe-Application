							...
							<div className="w-full md:w-1/2 px-4 mb-6 md:mb-0">
								<div className="h-full p-6 bg-gray-500 rounded-xl">
									<div className="flex items-center">
										...
										<div>
											<h5 className="text-xs text-gray-300 leading-6 font-semibold">
												Monthly Payment
											</h5>
									...
									<div className="flex items-center">
										...
										<div>
											...
											<div className="flex items-center text-2xl leading-none text-gray-100 font-semibold">
												<span>145</span>
												<span className="inline-block ml-2 py-1 px-2 text-xs text-green-500 font-medium bg-teal-900 rounded-full">
													+12,0%
												</span>
											</div>
										</div>
						...
						<div className="px-10 pt-6 pb-10 mb-6 bg-gray-500 rounded-xl">
							<div className="flex flex-wrap items-center justify-between -mx-4 mb-6">
								...
								<div className="w-full sm:w-auto px-4">
									<a
										className="inline-flex items-center text-sm font-bold text-blue-500 hover:text-blue-400"
										href="#"
									>
										<svg
											width="16"
							...
							<div className="pb-6 mb-6 border-b border-gray-400">
								<div className="flex flex-wrap items-center justify-between -mx-4 -mb-5">
									<div className="w-full sm:w-auto px-4 mb-5">
										<div className="flex items-center">
											<img
												className="h-12 w-17 mr-4 self-start"
												src="trizzle-assets/logos/visa-logo.svg"
												alt=""
											/>
											<div>
												<h5 className="text-sm text-gray-100 leading-5 font-semibold">
													Visa ending in 3456
												</h5>
									...
									<div className="w-full sm:w-auto px-4 mb-5">
										<a
											className="inline-block ml-auto px-2 py-1 text-xs leading-6 text-gray-200 font-bold bg-gray-600 hover:bg-gray-700 rounded-lg transition duration-100"
											href="#"
										>
											Default
										</a>
							...
							<div>
								<div className="flex items-center">
									<img
										className="h-12 w-17 mr-4 self-start"
										src="trizzle-assets/logos/card-logo.svg"
										alt=""
									/>
									<div>
										<h5 className="text-sm text-gray-100 leading-5 font-semibold">
						...
						<div className="flex flex-wrap -mx-4">
							<div className="w-full md:w-1/2 px-4 mb-8 md:mb-0">
								<div className="max-w-xs mx-auto">
									...
									<p className="text-xs text-gray-300 leading-5 font-medium mb-4">
										All subscriptions are set to automatically renew, unless you cancel
							...
							<div className="w-full md:w-1/2 px-4">
								<div className="max-w-xs mx-auto">
									...
									<p className="text-xs text-gray-300 leading-5 font-medium mb-5">
										You will lose access to all premium features in your current
										subscription plan
									</p>
									<a
