            ...
            <div className="md:flex mb-14 max-w-xs sm:max-w-sm md:max-w-none">
              ...
              <div className="max-w-md">
                <p className="md:text-xl text-gray-900 font-semibold">
                  it's time to make delicious food the best recipes and
                  experience like a professional chef. it's time to make
                  delicious food the best recipes and experience like a
                  professional chef.
                </p>
              </div>
            </div>
