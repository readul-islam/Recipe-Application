...
import j from "../../assets/images/jessica.png"
const Demo = () => {
  return (
    <>
      ...
      <div class="flex flex-wrap -mx-4 xl:items-center">
        <div class="w-full lg:w-1/2 xl:w-3/5 px-4 order-last lg:order-first">
          <div class="relative max-w-xl mx-auto lg:mx-0 lg:max-w-3xl h-full">
            <img class="block w-full h-166 lg:h-full object-cover rounded-3xl" src={j} alt=""/>
...
<section class="py-8">
  <div class="container px-4 mx-auto">
    <div class=" mx-auto">
        ...
        <div class="w-full md:w-1/2 px-4 mb-6 md:mb-0">
          <div class="h-full p-6 bg-gray-500 rounded-xl">
            <div class="flex items-center">
              ...
              <div>
                <h5 class="text-xs text-gray-300 leading-6 font-semibold">Monthly Payment</h5>
        ...
        <div class="w-full md:w-1/2 px-4">
          <div class="h-full p-6 bg-gray-500 rounded-xl">
            <div class="flex items-center">
              ...
              <div>
                <h5 class="text-xs text-gray-300 leading-6 font-semibold">Total Clients</h5>
                <div class="flex items-center text-2xl leading-none text-gray-100 font-semibold">
                  <span>145</span>
                  <span class="inline-block ml-2 py-1 px-2 text-xs text-green-500 font-medium bg-teal-900 rounded-full">+12,0%</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="px-10 pt-6 pb-10 mb-6 bg-gray-500 rounded-xl">
        <div class="flex flex-wrap items-center justify-between -mx-4 mb-6">
          <div class="w-full sm:w-auto px-4 mb-2 sm:mb-0">
            <h4 class="text-lg text-gray-100 font-semibold">Payment methods</h4>
          </div>
          <div class="w-full sm:w-auto px-4">
            <a class="inline-flex items-center text-sm font-bold text-blue-500 hover:text-blue-400" href="#">
              ...
              <span class="ml-2">Add method</span>
            </a>
          </div>
        </div>
          ...
          <div class="flex flex-wrap items-center justify-between -mx-4 -mb-5">
            <div class="w-full sm:w-auto px-4 mb-5">
              <div class="flex items-center">
                ...
                <div>
                  <h5 class="text-sm text-gray-100 leading-5 font-semibold">Visa ending in 3456</h5>
                  <span class="text-xs text-gray-300 font-medium">Expires 04/2028</span>
                </div>
              </div>
            </div>
            <div class="w-full sm:w-auto px-4 mb-5"><a class="inline-block ml-auto px-2 py-1 text-xs leading-6 text-gray-200 font-bold bg-gray-600 hover:bg-gray-700 rounded-lg transition duration-100" href="#">Default</a></div>
          </div>
        </div>
        <div>
          <div class="flex items-center">
            <img class="h-12 w-17 mr-4 self-start" src="trizzle-assets/logos/card-logo.svg" alt=""/>
            <div>
              <h5 class="text-sm text-gray-100 leading-5 font-semibold">Visa ending in 3456</h5>
              <span class="text-xs text-gray-300 font-medium">Expires 04/2028</span>
            </div>
      ...
      <div class="p-6 mb-10 bg-gray-500 rounded-xl">
        <h4 class="text-lg text-gray-100 font-semibold mb-6">Invoices</h4>
        <div class="w-full mt-6 pb-4 overflow-x-scroll">
          <table class="w-full min-w-max">
            <thead>
              <tr class="text-left">
                <th class="p-0">
                  <div class="py-3 px-6 rounded-l-xl bg-gray-600">
                    <span class="text-xs text-gray-300 font-semibold">INVOICE ID</span>
                  </div>
                </th>
                <th class="p-0">
            ...
            <tbody>
              <tr>
                <td class="p-0">
                  <div class="h-16 p-6">
                    <h5 class="text-sm font-medium text-gray-100">INVOICE #3405</h5>
                  </div>
                </td>
                <td class="p-0">
                  <div class="h-16 p-6">
                    <span class="text-sm font-medium text-gray-100">$25.00</span>
                  </div>
                </td>
                <td class="p-0">
                  <div class="h-16 p-6">
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
          <div class="max-w-xs mx-auto">
            <h4 class="text-gray-50 font-bold mb-1">Auto renewal</h4>
            <p class="text-xs text-gray-300 leading-5 font-medium mb-4">All subscriptions are set to automatically renew, unless you cancel before the next renewal date.</p>
            <div class="flex items-center">
              <button class="flex items-center justify-center h-6 w-11 mr-3 bg-blue-500 rounded-full">
                <div class="h-5 w-5 rounded-full bg-transparent"></div>
                <div class="h-5 w-5 rounded-full bg-white"></div>
              </button>
              <span class="text-xs text-gray-300 font-medium">Auto renewal is turrned on</span>
            </div>
          </div>
        </div>
        <div class="w-full md:w-1/2 px-4">
          <div class="max-w-xs mx-auto">
            <h4 class="text-gray-50 font-bold mb-1">Cancel Subscription</h4>
            <p class="text-xs text-gray-300 leading-5 font-medium mb-5">You will lose access to all premium features in your current subscription plan</p>
            <a class="inline-block text-xs font-medium text-blue-500 hover:underline" href="#">Cancel Subscription</a>
          </div>
        </div>
      </div>
    </div>
